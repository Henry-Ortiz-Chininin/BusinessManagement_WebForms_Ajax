...
#Region "METODOS Y FUNCIONES"
        ...
        Public Function ListarDistribucion() As Boolean
            Try
                _objConexion = New AccesoDatosSQLServer
                Dim objParametros() As String = {"chr_Anno", _strAnno, _
                                                 "chr_Mes", _strMes}
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_usp_GastoDistribuido_Listar", objParametros)
        ...
        Public Function Distribucion() As Boolean
            Try
                ...
                Dim objParametros() As String = {"chr_Anno", _strAnno, _
                                                 "chr_Mes", _strMes, _
                                                 "var_Usuario", _strUsuario}
                _objConexion.EjecutarComando("SGC_usp_GastosDistribuidos_Generar", objParametros)
