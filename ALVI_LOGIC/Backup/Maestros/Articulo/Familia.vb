...
#Region "METODOS Y FUNCIONES"
        Public Function Registrar() As Boolean
            Try
                ...
                Dim objParametros() As String = {"chr_IdFamilia", _strIdFamilia, _
                                                "var_Descripcion", _strDescripcion, _
                                                "chr_Estado", _strEstado, _
                                                "var_Usuario", _strUsuario}
                _objConexion.EjecutarComando("SGC_uspe_Familia_Registrar", objParametros)
        ...
        Public Function Eliminar() As Boolean
            Try
                ...
                _objConexion.EjecutarComando("SGC_uspe_Familia_Eliminar", objParametros)
        ...
        Public Function Obtener() As Boolean
            Try
                _objConexion = New AccesoDatosSQLServer
                Dim objParametros() As String = {"chr_IdFamilia", _strIdFamilia}
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_Familia_Obtener", objParametros)
        ...
        Public Function Listar() As Boolean
            Try
                _objConexion = New AccesoDatosSQLServer
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_Familia_Listar")
