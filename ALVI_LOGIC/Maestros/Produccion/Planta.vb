...
#Region "METODOS Y FUNCIONES"
        Public Function Registrar() As Boolean
            Try
                ...
                Dim objParametros() As String = {"var_IdPlanta", _strIdPlanta, _
                                                "var_IdCentroCosto", _strIdCentroCosto, _
                                                "var_Descripcion", _strDescripcion, _
                                                "chr_Estado", _strEstado, _
                                                "var_Usuario", _strUsuario}
                _objConexion.EjecutarComando("SGC_uspe_Planta_Registrar", objParametros)
        ...
        Public Function Eliminar() As Boolean
            Try
                _objConexion = New AccesoDatosSQLServer
                Dim objParametros() As String = {"var_IdPlanta", _strIdPlanta}
                _objConexion.EjecutarComando("SGC_uspe_Planta_Eliminar", objParametros)
        ...
        Public Function Obtener() As Boolean
            Try
                _objConexion = New AccesoDatosSQLServer
                Dim objParametros() As String = {"var_IdPlanta", _strIdPlanta}
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_Planta_Obtener", objParametros)
        ...
        Public Function Listar() As Boolean
            Try
                _objConexion = New AccesoDatosSQLServer
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_Planta_Listar")
