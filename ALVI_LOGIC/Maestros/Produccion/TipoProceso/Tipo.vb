...
#Region "METODOS Y FUNCIONES"
        Public Function Registrar() As Boolean
            Try
                ...
                _objConexion.EjecutarComando("SGC_uspe_AtributoPProceso_Registrar", objParametros)
        ...
        Public Function Eliminar() As Boolean
            Try
                ...
                _objConexion.EjecutarComando("SGC_uspe_AtributoPProceso_Eliminar", objParametros)
        ...
        Public Function Obtener() As Boolean
            Try
                _objConexion = New AccesoDatosSQLServer
                Dim objParametros() As String = {"chr_IdAtributo", _strIdAtributoTipo}
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_AtributoPProceso_Obtener", objParametros)
        ...
        Public Function Listar() As Boolean
            Try
                _objConexion = New AccesoDatosSQLServer
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_AtributoPProceso_Listar")
        ...
        Public Function Buscar() As Boolean
            Try
                ...
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_AtributoPProceso_Buscar", objParametros)
