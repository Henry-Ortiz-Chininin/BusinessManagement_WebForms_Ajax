...
#Region "METODOS Y FUNCIONES"
        Public Function Registrar() As Boolean
            Try
                ...
                _objConexion.EjecutarComando("SGC_uspe_RecetaValor_Registrar", objParametros)
        ...
        Public Function Eliminar() As Boolean
            Try
                ...
                _objConexion.EjecutarComando("SGC_uspe_RecetaValor_Eliminar", objParametros)
        ...
        Public Function Obtener() As Boolean
            Try
                ...
                Dim objParametros() As String = {"chr_IdAtributo", _strIdAtributoTipo, _
                                                 "var_IdAtributoValor", _strIdAtributoValor}
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_RecetaValor_Obtener", objParametros)
        ...
        Public Function Listar() As Boolean
            Try
                ...
                _objConexion = New AccesoDatosSQLServer
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_RecetaValor_Listar", objParametros)
        ...
        Public Function Buscar() As Boolean
            Try
                ...
                _objConexion = New AccesoDatosSQLServer
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_RecetaValor_Buscar", objParametros)
