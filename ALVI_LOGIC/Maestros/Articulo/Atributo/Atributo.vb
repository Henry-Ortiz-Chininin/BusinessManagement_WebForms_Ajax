...
#Region "METODOS Y FUNCIONES"
        Public Function Registrar() As Boolean
            Try
                ...
                _objConexion.EjecutarComando("SGC_uspe_AtributoTipo_Registrar", objParametros)
        ...
        Public Function Eliminar() As Boolean
            Try
                _objConexion = New AccesoDatosSQLServer
                Dim objParametros() As String = {"chr_IdAtributo", _strIdAtributoTipo, _
                                                 "var_IdSubFamilia", _strIdSubFamilia}
                _objConexion.EjecutarComando("SGC_uspe_AtributoTipo_Eliminar", objParametros)
        ...
        Public Function Obtener() As Boolean
            Try
                ...
                Dim objParametros() As String = {"chr_IdAtributo", _strIdAtributoTipo, _
                                                 "var_IdSubFamilia", _strIdSubFamilia}
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_AtributoTipo_Obtener", objParametros)
        ...
        Public Function Listar() As Boolean
            Try
                ...
                _objConexion = New AccesoDatosSQLServer
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_AtributoTipo_Listar", objParametros)
