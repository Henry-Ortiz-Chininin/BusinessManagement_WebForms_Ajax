...
#Region "METODOS Y FUNCIONES"
        Public Function Registrar(ByVal dtbAtributos As DataTable) As Boolean
            Try
                ...
                "num_Total", _dblTotal}
                _objConexion.EjecutarComando("SGC_uspe_Notadebito_Registrar", objParametros)
                Return True
        ...
        Public Function Eliminar() As Boolean
            Try
                ...
                _objConexion.EjecutarComando("SGC_uspe_Notadebito_Eliminar", objParametros)
                Return True
            Catch ex As Exception
                Me._exError = ex
                Return False
        ...
        Public Function Obtener() As Boolean
            Try
                _objConexion = New AccesoDatosSQLServer
                Dim objParametros() As String = {"var_IdNota", _strIdNota}
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_Notadebito_Obtener", objParametros)
        ...
        Public Function ObtenerAtributos() As Boolean
            Try
                _objConexion = New AccesoDatosSQLServer
                Dim objParametros() As String = {"var_IdNota", _strIdNota}
                _dtbAtributos = _objConexion.ObtenerDataTable("SGC_uspe_NotadebitoAtributo_Obtener", objParametros)
        ...
        Public Function SerieMayor() As Boolean
            Try
                _objConexion = New AccesoDatosSQLServer
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_Notadebito_ObtenerMayor")
                If _dtbDatos.Rows.Count > 0 Then
        ...
        Public Function Buscar() As Boolean
            Try
                ...
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_Notadebito_Buscar", objParametros)
                Return (_dtbDatos.Rows.Count > 0)
            Catch ex As Exception
                Me._exError = ex
                Return False
