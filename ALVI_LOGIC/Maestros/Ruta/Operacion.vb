...
#Region "METODOS Y FUNCIONES"
        Public Function Registrar() As Boolean
            Try
                ...
                Dim objParametros() As String = {"var_IdOperacion", _strIdOperacion, _
                                                "chr_IdProceso", _strIdProceso, _
                                                "var_Descripcion", _strDescripcion, _
                                                "chr_Estado", _strEstado, _
                                                "var_Usuario", _strUsuario}
                _objConexion.EjecutarComando("SGC_uspe_Operacion_Registrar", objParametros)
        ...
        Public Function Eliminar() As Boolean
            Try
                _objConexion = New AccesoDatosSQLServer
                Dim objParametros() As String = {"var_IdOperacion", _strIdOperacion, _
                                                 "chr_IdProceso", _strIdProceso}
                _objConexion.EjecutarComando("SGC_uspe_Operacion_Eliminar", objParametros)
        ...
        Public Function Obtener() As Boolean
            Try
                ...
                Dim objParametros() As String = {"var_IdOperacion", _strIdOperacion, _
                                                 "chr_IdProceso", _strIdProceso}
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_Operacion_Obtener", objParametros)
        ...
        Public Function Listar() As Boolean
            Try
                Dim objParametros() As String = {"var_IdProceso", _strIdProceso}
                _objConexion = New AccesoDatosSQLServer
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_Operacion_Listar", objParametros)
        ...
        Public Function Buscar() As Boolean
            Try
                ...
                _objConexion = New AccesoDatosSQLServer
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_uspe_Operacion_Buscar", objParametros)
