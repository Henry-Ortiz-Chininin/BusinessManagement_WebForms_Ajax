...
#Region "METODOS Y FUNCIONES"
        Public Function Registrar() As Boolean
            Try
                ...
                _objConexion.EjecutarComando("SGC_usps_AccesoTipo_Registrar", objParametros)
        ...
        Public Function Eliminar() As Boolean
            Try
                ...
                _objConexion.EjecutarComando("SGC_usps_AccesoTipo_Eliminar", objParametros)
        ...
        Public Function Obtener() As Boolean
            Try
                _objConexion = New AccesoDatos.AccesoDatosSQLServer
                Dim objParametros() As String = {"chr_IdAccesoTipo", _strIdAccesoTipo}
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_usps_AccesoTipo_Obtener", objParametros)
        ...
        Public Function Listar() As Boolean
            Try
                _objConexion = New AccesoDatos.AccesoDatosSQLServer
                _dtbDatos = _objConexion.ObtenerDataTable("SGC_usps_AccesoTipo_Listar")
