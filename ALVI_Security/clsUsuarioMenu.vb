...
#Region "METODOS Y FUNCIONES"
    Public Function Agregar() As Boolean
        Try
            ...
            Dim objParametros() As String = {"var_IdUsuario", _strIdUsuario, "int_IDMenu", _intIDMenu, "var_Usuario", _strUsuario}
            _objConexion.EjecutarComando("SGC_usp_UsuarioMenu_Agregar", objParametros)
    ...
    Public Function Eliminar() As Boolean
        Try
            _objConexion = New AccesoDatos.AccesoDatosSQLServer
            Dim objParametros() As String = {"var_IdUsuario", _strIdUsuario, "int_IDMenu", _intIDMenu}
            _objConexion.EjecutarComando("SGC_usp_UsuariMenuo_Eliminar", objParametros)
            Return True
        Catch ex As Exception
            Me._exError = ex
            Return False
    ...
    Public Function Obtener(ByVal pstrIdUsuario As String) As Boolean
        ...
        _dtbDatos.Columns.Add("var_IdUsuario", GetType(String))
        ...
        Try
            Dim dtbNivel0 As Data.DataTable = ObtenerxPerfil(pstrIdUsuario, 0, 0)
            ...
            If dtbNivel0.Rows.Count > 0 Then
                For Each dtrItemNivel As Data.DataRow In dtbNivel0.Rows
                    ...
                    dtrNuevo("var_IdUsuario") = dtrItemNivel("var_IdUsuario")
                    ...
                    Dim dtbNivel1 As Data.DataTable = ObtenerxPerfil(pstrIdUsuario, 1, dtrItemNivel("int_IDMenu"))
                    ...
                    If dtbNivel1.Rows.Count > 0 Then
                        For Each dtrItemNivel1 As Data.DataRow In dtbNivel1.Rows
                            ...
                            Dim dtbNivel2 As Data.DataTable = ObtenerxPerfil(pstrIdUsuario, 2, dtrItemNivel1("int_IDMenu"))
            ...
            Else
                ...
                dtrItem("var_IdUsuario") = _strIdUsuario
    ...
    Public Function ObtenerxPerfil(ByVal pstrIdUsuario As String, ByVal pintNivel As Int16, ByVal pintIDMenuPadre As Int16) As Data.DataTable
        Try
            ...
            Return objConexion.ObtenerDataTable("SGC_usp_UsuarioMenu_Obtener", objParametros)
