...
Partial Class Estandares_FGCESAN
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            Dim objSecurity As New ALVI_Security.General
            hdnIdFamilia.Value = Request("IdFA")
            hdnIdSubFamilia.Value = Request("IdSF")
            ...
            If hdnIdFamilia.Value <> "" Then
                objFamilia.IdFamilia = objSecurity.Decrypta(hdnIdFamilia.Value)
                If objFamilia.Obtener Then
                    lblFamilia.Text = objFamilia.Descripcion
                    If hdnIdSubFamilia.Value <> "" Then
                        objSubFamilia.IdFamilia = objSecurity.Decrypta(hdnIdFamilia.Value)
                        objSubFamilia.IdSubFamilia = objSecurity.Decrypta(hdnIdSubFamilia.Value)
                        If objSubFamilia.Obtener Then
                            lblSubFamilia.Text = objSubFamilia.Descripcion
                            If hdnIdAtributoTipo.Value <> "" Then
                                objAtributo.IdSubFamilia = objSecurity.Decrypta(hdnIdSubFamilia.Value)
    ...
    Private Sub Registrar()
        If txtCodigo.Text <> "" AndAlso txtDescripcion.Text <> "" _
            AndAlso hdnIdSubFamilia.Value <> "" AndAlso hdnIdAtributoTipo.Value <> "" Then
            Dim objAtributo As New ALVI_LOGIC.Maestros.Articulo.Atributo.Valores
            Dim objSecurity As New ALVI_Security.General
            objAtributo.IdAtributoTipo = objSecurity.Decrypta(hdnIdAtributoTipo.Value)
            objAtributo.IdSubFamilia = objSecurity.Decrypta(hdnIdSubFamilia.Value)
    ...
    Protected Sub btnCerrar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnCerrar.Click
        Dim strURL As String = "FGCESAM.ASPX"
        strURL = strURL & "?IdSeccion=" & Master.IdSeccion
        strURL = strURL & "&IdMenu=" & Master.IdMenu
        strURL = strURL & "&IdSubMenu=" & Master.IdSubMenu
        strURL = strURL & "&IdFamilia=" & hdnIdFamilia.Value
        strURL = strURL & "&IdSubFamilia=" & hdnIdSubFamilia.Value
    ...
    Protected Sub grdDatos_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grdDatos.RowCommand
        ...
        If e.CommandName = "Eliminar" Then
            ...
            objAtributo.IdSubFamilia = objSecurity.Decrypta(hdnIdSubFamilia.Value)
            objAtributo.IdAtributoTipo = objSecurity.Decrypta(hdnIdAtributoTipo.Value)
            objAtributo.IdValor = strParametros
