<%@ Page Language="VB" MasterPageFile="~/Masterpage/General.master" AutoEventWireup="false" CodeFile="FGCESAN.aspx.vb" Inherits="Estandares_FGCESAN" title="Sistema de Gestión de Costos - Alta Visión Consultores" %>
<%@ MasterType VirtualPath="~/Masterpage/General.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<div id="divCuerpo">
<div id="divHeader">Mantenimiento de Valores de Atributos por Sub-Familia de Articulos  - Lista</div>
<div id="divOpciones">
<table cellpadding="0" cellspacing="1" border="0">
    ...
    <tr>
        <td width="100" class="Titulo12">Familia</td>
        <td>
            <asp:HiddenField ID="hdnIdFamilia" runat="server" />
            <asp:Label CssClass="Titulo12" ID="lblFamilia" runat="server" Text=""></asp:Label>
        </td>        
    </tr>
    <tr>
        <td class="Titulo12">Sub-Familia</td>
        <td><asp:HiddenField ID="hdnIdSubFamilia" runat="server" />
            <asp:Label CssClass="Titulo12" ID="lblSubFamilia" runat="server" Text=""></asp:Label>
        </td>        
    </tr>    
    <tr>
        <td class="Titulo12">Atributo</td>
        <td><asp:HiddenField ID="hdnIdAtributoTipo" runat="server" />
    ...
    <Columns>
         <asp:BoundField DataField="var_IdAtributoValor" HeaderText="Código" />
        <asp:BoundField DataField="var_Descripcion" HeaderText="Descripción" >
            <ItemStyle Width="300" />
        </asp:BoundField>
        <asp:TemplateField>
        <ItemTemplate>
            <asp:ImageButton ID="btnModificar" CommandArgument='<%#Container.DataItem("var_IdAtributoValor") %>' CommandName="Modificar" ImageUrl="../images/btnAbrir.gif" runat="server" onmouseover="this.src='../images/btnAbrir_on.gif'" onmouseout="this.src='../images/btnAbrir.gif'" />
        </ItemTemplate>
        <ItemStyle Width="50" />
        </asp:TemplateField>
    <asp:TemplateField>
    <ItemTemplate>
        <asp:ImageButton ID="btnEliminar" CommandArgument='<%#Container.DataItem("var_IdAtributoValor") %>' CommandName="Eliminar" ImageUrl="../images/btnEliminar.gif" runat="server" onmouseover="this.src='../images/btnEliminar_on.gif'" onmouseout="this.src='../images/btnEliminar.gif'" />
    </ItemTemplate>
    <ItemStyle Width="50" />
    </asp:TemplateField>
    </Columns>
    ...
    <div id="divTitulo">Registro - Valor de Atributo por SubFamilia de Articulo</div>
