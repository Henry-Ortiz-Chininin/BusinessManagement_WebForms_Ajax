<%@ Page Title="" Language="VB" MasterPageFile="~/Masterpage/General.master" AutoEventWireup="false" CodeFile="FGLESAH.aspx.vb" Inherits="Estandares_FGLESAH" %>
...
<div id="divCuerpo"> 
<div id="divHeader">MAESTRO DE Validador - Listado
    </div>
...
<tr>
   ...
   <tr>  
    ...
    <Columns>
    <asp:BoundField DataField="var_IdValidador" HeaderText="Id" />
    ...
    <asp:TemplateField>
    <ItemTemplate>
        <asp:ImageButton ID="btnModificar" CommandArgument='<%#Container.DataItem("var_IdValidador") %>' CommandName="Modificar" ImageUrl="../images/btnAbrir.gif" runat="server" onmouseover="this.src='../images/btnAbrir_on.gif'" onmouseout="this.src='../images/btnAbrir.gif'" />
    </ItemTemplate>
    <ItemStyle Width="50" />
    </asp:TemplateField>
    <asp:TemplateField>
    <ItemTemplate>
        <asp:ImageButton ID="btnEliminar" CommandArgument='<%#Container.DataItem("var_IdValidador") %>' CommandName="Eliminar" ImageUrl="../images/btnEliminar.gif" runat="server" onmouseover="this.src='../images/btnEliminar_on.gif'" onmouseout="this.src='../images/btnEliminar.gif'" />
    </ItemTemplate>
    <ItemStyle Width="50" />
    </asp:TemplateField>
    </Columns>
    ...
    <asp:Panel ID="pnlFormulario" CssClass="Formulario" runat="server">
     <div id="divTitulo">MAESTRO DE Validador - Registro</div>
    <table cellpadding="1" cellspacing="1" border="0" width="500" align="center" valign="middle">

     <tr>
        <td class="Titulo12" width="150">Código</td>
        <td width="340">
            <asp:TextBox CssClass="Texto12" onChange="validadigito(this,'ALN');" onKeypress="return Valida(event, 'ALN');" MaxLength="10" ID="txtCodigoValidador" runat="server"></asp:TextBox></td>
    </tr>
        <caption>
            ...
            <tr>
              ...
              <tr>
        <td class="Titulo12">Condicion</td>
        <td>
            <asp:DropDownList ID="ddlCondicion" CssClass="texto12" runat="server">
            </asp:DropDownList>
        </td>
         </tr>
            <tr>
