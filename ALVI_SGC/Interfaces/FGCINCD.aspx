<%@ Page Language="VB" MasterPageFile="~/Masterpage/General.master" AutoEventWireup="false" CodeFile="FGCINCD.aspx.vb" Inherits="Interfaces_FGCINCD" title="Sistema de Gestión de Costos - Alta Visión Consultores" %>
...
<div id="divCuerpo">
<div id="divHeader">Modificación de Ingresos al Almacen</div>
<div id="divOpciones">
<table cellpadding="1" cellspacing="1" border="0">
    <tr>
    <td><asp:ImageButton ID="btnBuscar" runat="server" 
    onmouseover="this.src='../images/btnBuscar_on.gif'" 
    onmouseout="this.src='../images/btnBuscar.gif'" ImageUrl="../images/btnBuscar.gif" /></td>
...
<asp:GridView ID="grdDatos" Width="1000"  ShowFooter="true" AutoGenerateColumns="false" runat="server" AllowPaging="true" PageSize="20" >
    ...
    <asp:BoundField DataField="num_CostoUnitario" HeaderText="Precio/Und" DataFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right" />
       <asp:BoundField DataField="num_ImporteMoneda" HeaderText="Importe" DataFormatString="{0:#,##0.0000}" ItemStyle-HorizontalAlign="Right" />
    <asp:BoundField DataField="var_Moneda" HeaderText="MON" />
    <asp:BoundField DataField="num_TipoCambio" HeaderText="TC" DataFormatString="{0:#,##0.0000}" ItemStyle-HorizontalAlign="Right" />
    <asp:BoundField DataField="num_Importe" HeaderText="Importe S/." DataFormatString="{0:#,##0.0000}" ItemStyle-HorizontalAlign="Right" />
