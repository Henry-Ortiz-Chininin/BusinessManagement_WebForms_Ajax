...
Partial Class Interfaces_FGCINCA
    ...
    Private Sub LimpiarFormulario()
        If pnlFormulario.Visible = True Then
            ...
            txtTipoCambio.Text = Master.TipoCambio
    ...
    Protected Sub btnRegistrar2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnRegistrar2.Click
        ...
        ddlAlmacen.SelectedValue <> "" Then
            ...
            dtrNuevo("num_ImporteMoneda") = txtImporteMoneda.Text
            dtrNuevo("num_TipoCambio") = txtTipoCambio.Text
    ...
    Protected Sub grdDatos_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grdDatos.RowCommand
        If e.CommandName = "Modificar" Then
            ...
            For Each dtrItem As Data.DataRow In dtbDatos.Select("var_IdArticulo='" & e.CommandArgument.ToString & "'")
                ...
                txtTipoCambio.Text = dtrItem("num_TipoCambio")
                txtImporteMoneda.Text = dtrItem("num_ImporteMoneda")
            Next
        End If
    ...
    Private Sub CalcularImporte()
        If txtCantidad.Text <> "" AndAlso txtImporte.Text <> "" AndAlso txtTipoCambio.Text <> "" Then
            If IsNumeric(txtCantidad.Text) AndAlso IsNumeric(txtImporte.Text) Then
                If txtCantidad.Text > 0 AndAlso txtImporte.Text > 0 Then
                    ...
                    txtImporteMoneda.Text = txtImporte.Text
                    If ddlMoneda.SelectedValue = "D" Then
                        txtImporteMoneda.Text = txtImporte.Text * txtTipoCambio.Text
                    End If
                Else
                    txtCostoUnitario.Text = "0.00"
                    txtImporteMoneda.Text = "0.00"
                End If
            Else
                txtCostoUnitario.Text = "0.00"
                txtImporteMoneda.Text = "0.00"
