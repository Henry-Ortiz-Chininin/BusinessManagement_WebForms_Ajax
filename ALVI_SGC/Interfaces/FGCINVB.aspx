<%@ Page Language="VB" MasterPageFile="~/Masterpage/General.master" AutoEventWireup="false" CodeFile="FGCINVB.aspx.vb" Inherits="Estandares_FGCINVB" title="Sistema de Gestión de Costos - Alta Visión Consultores sin título" %>
...
<div id="divCuerpo">
<div id="divHeader">Notas de Credito</div>  
<div id="divOpciones">
<table cellpadding="0" cellspacing="1" border="0"> 
 ...
 <table cellpadding="3" cellspacing="3" border="0"> 
    ...
    <div id="divTitulo">Registro - Notas de Credito</div>
 ...
 <td>
        ...
        <tr>
            ...
            <td>
            <asp:ImageButton ID="btnBuscaComprobante" runat="server" onmouseover="this.src='../images/lupa_on.gif'" onmouseout="this.src='../images/lupa.gif'" ImageUrl="../images/lupa.gif" />
            ...
            <asp:Label ID="lblTipo" Text = "Tipo :" runat="server" Width = "50"></asp:Label>
            </td>
            <td>
    ...
    <table cellpadding="2" cellspacing="2" border="0" width="700" align="center" valign="middle">
        <td>
                           ...
                           <asp:UpdatePanel ID = "upnFecInicio" runat = "server" >
                            <ContentTemplate >
                            <asp:Image ID="btnFecInicio" runat="server" ImageUrl="~/Images/im_calendar.gif" />
                            </ContentTemplate> 
                             <Triggers>  
                              <asp:AsyncPostBackTrigger ControlID="ddlfiltro" EventName="SelectedIndexChanged" />
                              </Triggers> 
                           ...
                           <asp:UpdatePanel ID = "unpbtnFecfin" runat = "server">
                            ...
                            <asp:ImageButton ID="btnFiltrar" runat="server" onmouseover="this.src='../images/btnBuscar_on.gif'" onmouseout="this.src='../images/btnBuscar.gif'" ImageUrl="../images/btnBuscar.gif" />
                            </td> </tr> 
                            </table>  
                            </td>
         <tr> 
             <td colspan="6"">
             <hr width="100%" height="1" noshadow /></td></tr> 
              <tr>  
                 <td colspan="6">  
                   <div id="Div1" runat="server" class="Lista">
                              <asp:GridView ID="grdBusqueda" runat="server" align="center" 
                                            ...
                                            <asp:BoundField DataField="dtm_FechaVencimiento"  DataFormatString= "{0:dd/MM/yyyy}"  HeaderText="vencimiento" >
                                            <ItemStyle Width="50" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="var_TipoServicio" HeaderText="Tipo Servicio" />
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnAsignar" runat="server" CommandName="Asignar"  CommandArgument = '<%#Container.DataItemIndex%>'
            ...
            <tr><td colspan="6""><hr width="100%" height="1" noshadow /></td></tr>
                            ...
                            <div id="pnlLista" runat="server" class="Lista"> 
                                         <asp:GridView ID="grdArticulos" runat="server" align="center"  
                                            ...
                                            <asp:TemplateField HeaderText="D%">    
                                                    <ItemTemplate>   
                                                   <asp:TextBox ID="txtDescPantalla" width="70"  CssClass="Texto12" runat="server"></asp:TextBox>
                                                    </ItemTemplate>
                                                <ItemStyle Width="50"/>  
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Importe">
                                                    <ItemTemplate>
                                                   <asp:TextBox ID="txtImporte" width="70" Text = '<%#Container.DataItem("num_ImportePantalla")%>' CssClass="Texto12" runat="server"></asp:TextBox>
                                                    </ItemTemplate>   
                                                <ItemStyle Width="50" />   
                                            </asp:TemplateField>
                ...
                <tr>
        <td>
        <table cellpadding="2" cellspacing="6" border="0" width="500" align="center" valign="middle">
        <tr>
              
        <td align="left"> 
                <asp:ImageButton ID="btnDocumentoAceptar" runat="server" onmouseover="this.src='../images/btnAceptar_on.gif'" onmouseout="this.src='../images/btnAceptar.gif'" ImageUrl="../images/btnAceptar.gif" />
                 <asp:ImageButton ID="btnCancelarDocumento" runat="server" onmouseover="this.src='../images/btnCancelar_on.gif'" onmouseout="this.src='../images/btnCancelar.gif'" ImageUrl="../images/btnCancelar.gif" />
        </td>
        </tr>
