<%@ Page Language="VB" MasterPageFile="~/Masterpage/General.master" AutoEventWireup="false" CodeFile="FGCINCF.aspx.vb" Inherits="Interfaces_FGCINCF" title="Página sin título" %>
...
<div id="divCuerpo">
<div id="divHeader">Busqueda de Ingresos al Almacen</div>
<div id="divOpciones">
<table cellpadding="0" cellspacing="1" border="0">
    ...
    <asp:BoundField DataField="dtm_FechaMovimiento" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Fecha" />
