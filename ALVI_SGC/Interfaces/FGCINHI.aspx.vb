...
Partial Class Interface_FGCINHI
    ...
    Private Sub BindDespacho(ByVal strIdOrden As String)
        ...
        Dim objMovimiento As New ALVI_LOGIC.Proceso.Logistica.Kardex.Movimiento
        objMovimiento.ListarMaterialACT(strIdOrden)
    ...
    Private Sub BindCuentaGasto(ByRef ddlCuentaGasto As DropDownList)
        ...
        Dim dtvDatos As New Data.DataView(dtbDatos, "", "var_Descripcion ASC", Data.DataViewRowState.OriginalRows)
    ...
    Private Sub BindTipoMovimiento()
        ...
        End If
        ddlTipoMovimiento.SelectedValue = "S03"
    End Sub
    ...
    Public Sub DataPanel()

        If Session("diferencia") = 1 Then
            Dim dtbPDatos As New Data.DataTable
        ...
        If Session("diferencia") = 2 Then
            Dim dtbPDatos As Data.DataTable = CType(Session("tablaPanel"), Data.DataTable)
            Dim dtrpanel As Data.DataRow = CType(Session("tablaPanel"), Data.DataTable).NewRow
            dtrpanel("Codigo") = ddlPTipoDocumento.SelectedValue
            dtrpanel("IdProveedor") = hdnIdProveedor.Value
            dtrpanel("Tipo") = ddlPTipoDocumento.SelectedItem
            dtrpanel("numero") = txtNumeroDocumento.Text
            dtrpanel("Fecha") = txtFechaDoc.Text
            dtrpanel("Observacion") = txtImporte.Text
            dtbPDatos.LoadDataRow(dtrpanel.ItemArray, True)
            dtbPDatos.AcceptChanges()
            Session("tablaPanel") = dtbPDatos
            grdProveedor.DataSource = dtbPDatos
            grdProveedor.DataBind()
        End If
        Session("diferencia") = 2
    ...
    Protected Sub btnRegistrar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnRegistrar.Click
        ...
        For Each grdItem As GridViewRow In grdDatos.Rows
            ...
            Dim ddlCuentaGasto As DropDownList = CType(grdItem.FindControl("ddlCuentaGasto"), DropDownList)
            If txtDespacho.Text <> "" AndAlso ddlAlmacen.SelectedValue <> "" AndAlso ddlCuentaGasto.SelectedValue <> "" Then
                Dim dtrNuevo As Data.DataRow = dtbDatos.NewRow
                dtrNuevo("var_IdArticulo") = grdItem.Cells(2).Text
                dtrNuevo("var_IdUnidadMedida") = grdItem.Cells(10).Text
                dtrNuevo("var_IdAlmacen") = ddlAlmacen.SelectedValue
                dtrNuevo("var_IdCentroCosto") = grdItem.Cells(0).Text
                dtrNuevo("var_IdCuentaGasto") = ddlCuentaGasto.SelectedValue
