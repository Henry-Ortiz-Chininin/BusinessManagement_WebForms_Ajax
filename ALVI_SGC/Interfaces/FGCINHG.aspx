<%@ Page Title="" Language="VB" MasterPageFile="~/Masterpage/General.master" AutoEventWireup="false" CodeFile="FGCINHG.aspx.vb" Inherits="Interface_FGCINHG" %>
...
<div id="divCuerpo">
<div id="divHeader">Ingreso por Servicio de Terceros</div>
<div id="divOpciones">
...
<table cellpadding="1" cellspacing="1" border="0" width="500">
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Ingreso">
            <ItemTemplate>
                <asp:TextBox ID="txtDespacho"  onChange="validadigito(this,'NUM');" onKeypress="return Valida(event, 'NUM');" CssClass="Texto12" runat="server"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:BoundField DataField="var_UnidadMedida" HeaderText="Metrica" /> 
        <asp:BoundField DataField="num_CantidadDespacho" HeaderText="Pendiente" />
        <asp:BoundField DataField="num_CantidadOrden" HeaderText="Enviado" />
