...
Partial Class Interfaces_FGCINCF
    ...
    Private Sub BindTipoMovimiento()
        ...
        End If
        ddlTipoMovimiento.Items.Insert(0, New ListItem("Seleccionar", "I"))
    ...
    Private Sub BindGrid()
        ...
        grdDatos.DataSource = New Data.DataView(objMovimientos.Datos, "chr_Clase='I'", "chr_IdKardex", Data.DataViewRowState.OriginalRows)
        grdDatos.DataBind()
    End Sub
    ...
    Protected Sub grdDatos_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grdDatos.RowCommand
        If e.CommandName = "Modificar" Then
            ...
            Dim strURL As String = "FGCINCD.ASPX"
