<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlUnidadMedida_Buscar.ascx.vb" Inherits="Controles_ctlUnidadMedida_Buscar" %>
<asp:UpdatePanel ID="upnCtlProceso" runat="server" >
<ContentTemplate>
<div id="pnlCentroCosto" class="clsControlBusqueda">  
    
    <div class ="Titulo">
    <asp:Label ID="lblTitulo" runat="server" Text="Unidad de Medida"></asp:Label></div>
<table cellpadding="0" cellspacing="0" border="0" width="500">

    <tr>  
        <td class="Titulo12" width="100" >Codigo</td>
        <td><asp:TextBox ID="txtIdUnidadMedida" AutoPostBack="true" CssClass="Codigo" runat="server"></asp:TextBox></td>
    ...
    <asp:DataList ID="dtlLista" runat="server">
        <ItemTemplate>
           <asp:LinkButton ID="btnSeleccion2" CommandArgument='<%#Container.DataItem("var_IdUnidadMedida") %>' CommandName="Seleccionar" CssClass="ListaItem" runat="server" Text='<%#Container.DataItem("var_Descripcion") %>' />
        </ItemTemplate>        
    </asp:DataList> 
    </div>
    </td>
