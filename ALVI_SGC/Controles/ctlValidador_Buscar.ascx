<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlValidador_Buscar.ascx.vb" Inherits="Controles_ctlValidador_Buscar" %>
<asp:UpdatePanel ID="upnCtlPersonal" runat="server" >
<ContentTemplate>
<div id="pnlPersonal" class="clsControlBusqueda">
 <div class ="Titulo">Validador</div>
<table cellpadding="0" cellspacing="0" border="0" width="150">
    <tr>
        <td class="Titulo12" width="100" >Codigo</td>
        <td><asp:TextBox ID="txtIdValidador"  AutoPostBack="true"  CssClass="Codigo" runat="server"></asp:TextBox></td>
    ...
    <asp:DataList ID="dtlLista" runat="server"> 
        <ItemTemplate>
            ...
            <tr>
            <td width="80"><asp:LinkButton ID="btnSeleccion1" CommandArgument='<%#Container.DataItem("var_IdValidador") %>' CommandName="Seleccionar" CssClass="ListaItem" runat="server" Text='<%#Container.DataItem("var_IdValidador") %>' /></td>
            <td width="210"><asp:LinkButton ID="btnSeleccion2" CommandArgument='<%#Container.DataItem("var_IdValidador") %>' CommandName="Seleccionar" CssClass="ListaItem" runat="server" Text='<%#Container.DataItem("var_Nombre") %>' /></td>
            <td width="210"><asp:LinkButton ID="btnSeleccion3" CommandArgument='<%#Container.DataItem("var_IdValidador") %>' CommandName="Seleccionar" CssClass="ListaItem" runat="server" Text='<%#Container.DataItem("var_Apellidos") %>' /></td>
            </tr>
            </table>
        </ItemTemplate>        
    </asp:DataList>
    ...
    <Triggers>
        ...
        <asp:AsyncPostBackTrigger ControlID="txtIdValidador" EventName="TextChanged" />
