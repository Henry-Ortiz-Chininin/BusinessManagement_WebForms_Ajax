<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlArticulo_BuscarIQ.ascx.vb" Inherits="Controles_ctlArticulo_BuscarIQ" %>
...
<table cellpadding="0" cellspacing="0" border="0" width="500"> 
    ...
    <tr>
        <td class="Titulo12" width="150" >Unidad de Medida</td>
        <td>
