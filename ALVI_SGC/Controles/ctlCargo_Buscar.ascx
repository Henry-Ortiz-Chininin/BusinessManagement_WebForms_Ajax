<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlCargo_Buscar.ascx.vb" Inherits="Controles_ctlCargo_Buscar" %>
...
<table cellpadding="0" cellspacing="0" border="0" width="80">
    <tr>  
        ...
        <td><asp:TextBox ID="txtIdCargo" AutoPostBack="true" CssClass="Codigo" runat="server"></asp:TextBox></td>
    ...
    <asp:DataList ID="dtlLista" runat="server">
        <ItemTemplate>
            <asp:LinkButton ID="btnSeleccion2" CommandArgument='<%#Container.DataItem("var_IdCargo") %>' CommandName="Seleccionar" CssClass="ListaItem" runat="server" Text='<%#Container.DataItem("var_Descripcion") %>' />
        </ItemTemplate>        
    </asp:DataList> 
    </div>
    </td>
    ...
    <Triggers>
        ...
        <asp:AsyncPostBackTrigger ControlID="txtIdCargo" EventName="TextChanged" />
