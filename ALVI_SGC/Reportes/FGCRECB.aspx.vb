...
Partial Class Reportes_FGCRECB
    ...
    Private Function GenerarReporte() As CrystalDecisions.CrystalReports.Engine.ReportDocument
        ...
        rpt.Load(Server.MapPath("./") + "REOPCB01.rpt")

        objDatos.Buscar(Request("Inicio"), Request("Final"))
        rpt.SetDataSource(objDatos.Datos)
    ...
    Public Sub exportarReporte(ByVal exp As CrystalDecisions.Shared.ExportFormatType)
        If rpt2.Rows.Count > 0 Then
            rpt2.ExportToHttpResponse(exp, Response, True, "Control_CajaBanco")
        End If
