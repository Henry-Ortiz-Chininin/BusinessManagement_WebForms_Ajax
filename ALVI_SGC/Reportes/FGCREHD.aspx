<%@ Page Language="VB" MasterPageFile="~/Masterpage/General.master" AutoEventWireup="false" CodeFile="FGCREHD.aspx.vb" Inherits="Reportes_FGCREHD" title="Página sin título" %>
...
<div id="divCuerpo">
<div id="divHeader">Reporte de Ventas</div> 
<div id="divOpciones">
...
<%--    <td><asp:ImageButton ID="btnExportar" runat="server" onmouseover="this.src='../images/btnExportar_on.gif'" onmouseout="this.src='../images/btnExportar.gif'" ImageUrl="../images/btnExportar.gif" /></td>--%>
    ...
    <table cellpadding="1" cellspacing="1" border="0">
        ...
        <table> <tr>
            ...
            <td><nobr>
                <asp:TextBox ID="txtDesde" runat="server"  Width ="80"></asp:TextBox>&nbsp;
                <asp:Image ID="btnDesde" runat="server" ImageUrl="~/Images/im_calendar.gif" />
                </nobr>
            </td>
            <td class="Titulo12">Hasta</td>
            <td><nobr>
                <asp:TextBox ID="txtHasta" runat="server"  Width ="80"></asp:TextBox>&nbsp;
        ...
        <tr> <td> 
        <table> <tr> <td class="Titulo12" width = "100"> 
        Tipo Documento
        </td><td class="Titulo12">
                    <asp:DropDownList ID="ddlTipoDocumento" runat="server">
                    <asp:ListItem value = "">TODOS</asp:ListItem> 
                    <asp:ListItem value = "ND">NOTA DE DEBITO</asp:ListItem>
                    <asp:ListItem value = "NC">NOTA DE CREDITO</asp:ListItem>
